...
bool rainbowHorizontal(led_t *currentKeyLedColors, uint8_t intensity, const uint32_t *colorPalette_, const uint32_t colorPaletteLength) {
...
bool rainbowVertical(led_t *currentKeyLedColors, uint8_t intensity, const uint32_t *colorPalette_, const uint32_t colorPaletteLength) {
...
bool animatedRainbowVertical(led_t *currentKeyLedColors, uint8_t intensity, const uint32_t *colorPalette_, const uint32_t colorPaletteLength) {
  for (uint16_t i = 0; i < NUM_COLUMN; ++i) {
    for (uint16_t j = 0; j < NUM_ROW; ++j) {
      setKeyColor(&currentKeyLedColors[j * NUM_COLUMN + i],
