 ...
 */
typedef bool (*lighting_callback)(led_t *, uint8_t, const uint32_t *, const uint32_t);
...
profile profiles[15] = {
    // {red, {0, 0, 0, 0}, NULL, NULL, NULL, 0},
    // {green, {0, 0, 0, 0}, NULL, NULL, NULL, 0},
    // {blue, {0, 0, 0, 0}, NULL, NULL, NULL, 0},
    ...
    // {miamiNights, {0, 0, 0, 0}, NULL, NULL, NULL, 0},
    {static_colors_mod_keys, {0, 0, 0, 0}, NULL, NULL, miamiNightsPalette, LEN(miamiNightsPalette)},
    {rainbowHorizontal, {0, 0, 0, 0}, NULL, NULL, NULL, 0},
    {rainbowVertical, {0, 0, 0, 0}, NULL, NULL, NULL, 0},
...
void executeProfile(bool init) {
  ...
  reactiveNeedsUpdate = profiles[currentProfile].callback(ledColors, ledIntensity, profiles[currentProfile].colorPalette, profiles[currentProfile].colorPaletteLength);
}
